...
var Specification_entities_1 = require("../entities/Specification.entities");
var SpecificationRepository = /** @class */ (function () {
    function SpecificationRepository() {
        this.repository = (0, typeorm_1.getRepository)(Specification_entities_1.Specification);
    }
    ...
    SpecificationRepository.prototype.findByName = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var specification;
            return __generator(this, function (_a) {
                specification = this.repository.findOne({ name: name });
