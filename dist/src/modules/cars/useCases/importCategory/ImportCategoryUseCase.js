...
exports.ImporCategoryUseCase = void 0;
var csv_parse_1 = require("csv-parse");
var fs_1 = __importDefault(require("fs"));
var tsyringe_1 = require("tsyringe");
var ImporCategoryUseCase = /** @class */ (function () {
    function ImporCategoryUseCase(categoryRepository) {
        this.categoryRepository = categoryRepository;
    }
    ImporCategoryUseCase.prototype.loadCategories = function (file) {
        var _this = this;
    ...
    ImporCategoryUseCase.prototype.execute = function (file) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, this.categoryRepository.findByName(name)];
                                    case 1:
                                        existCategory = _a.sent();
                                        if (!!existCategory) return [3 /*break*/, 3];
                                        return [4 /*yield*/, this.categoryRepository.create({
                                                name: name,
                                                description: description,
                                            })];
                                    case 2:
    ...
    ImporCategoryUseCase = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)("CategoryRepository")),
        __metadata("design:paramtypes", [Object])
    ], ImporCategoryUseCase);
    return ImporCategoryUseCase;
}());
exports.ImporCategoryUseCase = ImporCategoryUseCase;
