...
var ListCategoriesController = /** @class */ (function () {
    ...
    ListCategoriesController.prototype.handle = function (_request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var listCategoriesUseCase, all;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listCategoriesUseCase = tsyringe_1.container.resolve(ListCategoriesUseCase_1.ListCategoriesUseCase);
                        return [4 /*yield*/, listCategoriesUseCase.execute()];
                    case 1:
                        all = _a.sent();
