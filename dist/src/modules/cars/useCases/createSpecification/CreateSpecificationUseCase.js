...
var CreateSpecificationUseCase = /** @class */ (function () {
    ...
    CreateSpecificationUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.specificationRepository.findByName(name)];
                    case 1:
                        specificationAlreadyExists = _b.sent();
                        if (specificationAlreadyExists) {
                            throw new AppError_1.AppError("Specification already exists!");
                        }
                        return [4 /*yield*/, this.specificationRepository.create({ name: name, description: description })];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    CreateSpecificationUseCase = __decorate([
        ...
        __param(0, (0, tsyringe_1.inject)("SpecificationRepository")),
