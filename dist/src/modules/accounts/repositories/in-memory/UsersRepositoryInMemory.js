...
var Users_entity_1 = require("../../infra/typeorm/entities/Users.entity");
var UsersRepositoryInMemory = /** @class */ (function () {
    ...
    UsersRepositoryInMemory.prototype.create = function (_a) {
        var name = _a.name, email = _a.email, driver_license = _a.driver_license, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_b) {
                user = new Users_entity_1.User();
                Object.assign(user, {
                    name: name,
                    email: email,
