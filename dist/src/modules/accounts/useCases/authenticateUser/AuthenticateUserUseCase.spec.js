...
describe("Authenticate User", function () {
    ...
    it("should not be able to authenticate an nonexistent user", function () {
        expect(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, authenticateUserUseCase.execute({
    ...
    it("should not be able to authenticate with incorrect password", function () {
        expect(function () { return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, authenticateUserUseCase.execute(user)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, authenticateUserUseCase.execute({
                                email: user.email,
